...
export default function BuildTools() {
  return (
    <div className='border-b border-neutral-900 pb-4'>
      ...
      className='my-20 text-center text-4xl bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent text-4xl'>Build Tools</motion.h1>
      <div>
        {Build_tools.map((project,index)=>(
